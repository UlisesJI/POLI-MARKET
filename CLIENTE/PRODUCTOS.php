            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        $sql4 = "SELECT * FROM cliente_producto WHERE usuario='$user'";
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="align-middle"><?= mysqli_real_escape_string($conn, $row5['nom_producto'])?></td>
                            <td class="align-middle"><img src="<?= $row5['foto_producto1']?>" alt="" style="width: 50px;"></td>
                            <td class="align-middle">$<?= mysqli_real_escape_string($conn, $row5['precio_producto'])?></td>
                            <td class="align-middle"><?= mysqli_real_escape_string($conn, $row5['num_productos'])?></td>
                            <td class="align-middle"><a  href="PRODUCTO_USUARIO.php?producto=<?= $row5['cod_producto']?>&user=<?=$user?>" class="btn btn-sm text-dark p-0"><button style="color:white" class="btn btn-sm btn-primary">VISUALIZAR</button></a></td>
                            <td class="align-middle"><a  href="ELIMINAR_PRODUCTO.php?user=<?=$user?>&producto=<?=$row5['cod_producto']?>"><button class="btn btn-sm btn-primary"><i class="fa fa-times"></i></button></a><a href="MODIFICAR_PRODUCTO.php?user=<?=$user?>&producto=<?=$row5['cod_producto']?>"><button style="color:white" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></button></a></td>
                        </tr>
                        <?php endwhile;?>
                    </tbody>
                </table>
