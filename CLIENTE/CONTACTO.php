...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Haz tus preguntas</span></h2>
        </div>
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                <h5 class="font-weight-semi-bold mb-3">Mantente en contacto</h5>
                <p>Cualquier sugerencia puedes enviarla a nuestro correo polimarket@gmail.com</p>
