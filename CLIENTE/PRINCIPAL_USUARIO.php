...
$sql3 = "SELECT * FROM clientes WHERE usuario='$user'";
...
<body>
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <a href="LOGIN.html" class="btn border">
                    ...
                    <span class="badge"><?=$row3['usuario']?></span>
                </a>
                <a href="CART.php?user=<?=$row3['usuario']?>" class="btn border">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    ...
                    while($row =  mysqli_fetch_array($query2)):
                        ?><a href="CATEGORIA_USUARIO.php?categoria=<?=$row['id_categoria']?>&user=<?=$user?>" class="nav-item nav-link"><?=$row['nombre_categoria']?></a><?php
                    endwhile;
                    ?>
                    </div>
                </nav>
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">¡BIENVENIDO <?=$user?>!</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">CONSULTA TUS COMPRAS</h3>
                                    <a href="" class="btn btn-light py-2 px-3">CONSULTAR AHORA</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">¿QUIERES VENDER TUS PRODUCTOS?</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Ingresa tus productos aquí</h3>
                                    <a href="" class="btn btn-light py-2 px-3">VENDER AHORA</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="PRODUCTO_USUARIO.php?producto=<?= $row3['cod_producto']?>&user=<?=$user?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>DETALLES</a>
                        <a href="CARRITO.php?producto=<?=$code?>&user=<?=$user?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>AGREGAR AL CARRITO</a>
                    </div>
                </div>
            </div>
            <?php endfor; ?>
    ...
    <div><a href="TIENDA_USUARIO.php?user=<?=$user?>"><p style="font-size:20px; text-align: right; margin-right: 5%; color: red; text-decoration: underline;">VER MÁS</p></a></div>
    <!-- Footer Start -->
