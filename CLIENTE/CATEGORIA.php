...
<body>
    ...
    $sql4 = "SELECT * FROM categoria WHERE id_categoria= $categoria ";
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3"><?=mysqli_real_escape_string($conn, $row4['nombre_categoria'])?></h1>
        </div>
    </div>
    <!-- Page Header End -->
    <!-- Shop Start -->
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <?php while($row2 =  mysqli_fetch_array($query)): 
                        ...
                        $code=$row2['cod_producto'];
                        $sql3 = "SELECT * FROM productos WHERE cod_producto= $code";
