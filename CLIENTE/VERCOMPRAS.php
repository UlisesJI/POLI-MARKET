    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <?php 
                    $sql6 = "SELECT * FROM compras WHERE usuario='$user'";
                        $query6 = mysqli_query($conn, $sql6);
                        
                        while($row6= mysqli_fetch_array($query6)):
                            $id_compra=$row6["id_compra"];
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <thead class="bg-secondary text-dark">
                        <tr>
                            <th colspan="5">Compra Realizada el <?=$row6["fecha_compra"]?></th>
                        </tr>
                        <tr>
                            <th>Imagen</th>
                            <th>Producto</th>
                    ...
                    <tbody class="align-middle">
                        ...
                        $sql4 = "SELECT * FROM compras_producto WHERE id_compra='$id_compra'";
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="align-middle"><img src="<?= $row5['foto_producto1']?>" alt="" style="width: 100px;"></td>
                            <td class="align-middle"><?= mysqli_real_escape_string($conn, $row5['nom_producto'])?></td>
                            <td class="align-middle"><?= mysqli_real_escape_string($conn, $row4['num_productos'])?></td>
                            <td class="align-middle">$<?= mysqli_real_escape_string($conn, $row5['precio_producto'])?></td>
                            <td class="align-middle"><?= mysqli_real_escape_string($conn, $row4['estado'])?></td>
